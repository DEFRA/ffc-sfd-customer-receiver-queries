...
```
variableGroups:
    - ffc-sfd-customer-receiver-queries-snd1
    - ffc-sfd-customer-receiver-queries-snd2
    - ffc-sfd-customer-receiver-queries-snd3
variables:
    - ffc-sfd-customer-receiver-queries-APPINSIGHTS-CONNECTIONSTRING
```
